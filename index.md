...
- Wald, percentile, and basic bootstrap intervals for single-fit
  coefficient summaries
- MSM-based prediction, plotting, diagnostics, adequacy checks, and
  confidence regions
...
exposures of each mixture. For binary and count outcomes, check the
reported estimand scale before interpreting the coefficient table.
...
- coefficient confidence regions with
...
the effect-scales article, the function reference, and the fuller README
on GitHub.
...
- Read the [effect scales, intervals, and prediction scales
  article](https://cmowrer13.github.io/qgcomp.multi/articles/qgcompmulti-effect-scales.md)
  for the estimand-scale and interval behavior
- Browse the [function
