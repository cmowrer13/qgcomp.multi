...
outcome is generated from a model where the effects correspond to
simultaneous one-quantile increases in each mixture.
...
- sigma_eps:
  ...
  Standard deviation of the outcome error term.
...
discretized into quantile categories ranging from 0 to q-1. The outcome
is generated using the quantized exposures so that the parameters psi1,
psi2, and psi12 correspond directly to the estimands in two-mixture
quantile g-computation models.
